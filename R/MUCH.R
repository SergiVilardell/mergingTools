...
MUCH_merge <- function(data = NULL, n_pmcs = NULL, n_runs = NULL, n_sims = NULL, dep_lvl = NULL) {
  # Process the data coming from the experiments
  splitted_data <- mergingTools::process_raw_experiments(data = data, n_pmcs = n_pmcs)
